 ...
 * <p>
 * This will be called in the event that there is an exact match to an existing
 * "real" node being added to the trie.
 * 
...
public interface ValueMerger<T> {
	 ...
	 * 
	 * @param existingData
	 *            The radix data on the existing node.
	 * @param newValue
	 *            The new conflicting value to be added.
	 */
