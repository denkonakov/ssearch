 ...
 * <p>
 * This class maintains the tree structure while providing for data of type T to
...
public class Tree<T> {
	...
	public String toString() {
		return toString(new Escaper()); // substiture mock Escaper
	}
		...
		if (otherTree != null) {
			if (data == null && otherTree.data != null) {
				return false;
					...
					|| (data != null && data.equals(otherTree.data))) {
				if (children == null) {
					...
					for (int childNum = 0; childNum < numChildren; ++childNum) {
						...
						final Object otherChild = otherTree.children
								.get(childNum);
	...
	/**
	 * Determine whether this node is 'equidepth', defined as all terminal nodes
	 * under this node being at the same depth relative to this node.
	 */
